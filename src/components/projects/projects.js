...
function Projects() {
    const projects = [
       ...
       {title: 'HR Portal', repo: 'https://github.com/egraham96/HRPortal', img: HRPortal, desc: 'HR Portal is a web application that allows hiring managers and HR professionals to manage job applicants in a visually intuitive and effective manner. It allows users to input, modify, filter and score potential employees based on the results of their interviews.', tools: 'JavaScript, React, Express, NodeJS, MongoDB', site:'https://github.com/egraham96/HRPortal'},
